...
if __name__ == "__main__":
    ...
    parser.add_argument("--episode-dir", type=str,
                        default="/mnt/data/weiduo/heng/GR00T-WholeBodyControl/data/real_clean_up_table/cleanup_table_1_episode_9",
    ...
    parser.add_argument("--task-key", type=str, default="cleanup_table_1_episode_9",
