        ...
        while self._running and running.is_set():
            try:
                ...
                img_obs = {
                    ...
                    "observation.images.goal": subgoal_frame,
                }
...
def main(server_url, zmq_host, zmq_pub_port, zmq_sub_port, zmq_topic, zmq_sub_topic,
    ...
    # 3b. Initialize subgoal manager (loaded from episode folder)
    subgoal_manager = SubgoalManager(episode_dir=episode_dir)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--episode-dir", type=str,
                        default="/home/xiawei/data/put_chip_can_into_plate/episode_0",
